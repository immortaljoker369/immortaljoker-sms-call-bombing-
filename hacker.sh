#!/bin/bash
clear
echo -e "\e[4;31m welcom to HACKDOM!!! \e[0m"
echo -e "\e[1;34m be careful with the mudhiral family or else get ready to face me \e[0m"
echo -e "\e[1;32m BUNNY MUDHIRAJ \e[0m"
echo "welcome to new world bunny,be really carefull with this tool....dont put urself into any kind of problem...now hit the enter key to open the door"
read a1
...
figlet immortaljoker
echo -e "\e[4;34m This Bomber Was Created By immortaljoker \e[0m"
echo -e "\e[1;34m For Any queiries ring me a call!!!\e[0m"
echo -e "\e[1;32m           Mail: immortaljoker@gmail.com \e[0m"
echo " "
echo -e "\e[4;31m be careful bunny...dont put urself into any problem!!! \e[0m"
echo " "
